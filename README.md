...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7640&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/expat-cos7-aarch64-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Installing expat-cos7-aarch64
=============================

Installing `expat-cos7-aarch64` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:

```
conda config --add channels conda-forge
```

Once the `conda-forge` channel has been enabled, `expat-cos7-aarch64, expat-devel-cos7-aarch64` can be installed with:

```
conda install expat-cos7-aarch64 expat-devel-cos7-aarch64
```

It is possible to list all of the versions of `expat-cos7-aarch64` available on your platform with:

```
conda search expat-cos7-aarch64 --channel conda-forge
```
...
Updating expat-cos7-aarch64-feedstock
=====================================

If you would like to improve the expat-cos7-aarch64 recipe or build a new
...
Note that all branches in the conda-forge/expat-cos7-aarch64-feedstock are
